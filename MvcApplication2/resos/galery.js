...
function showBigFoto(picName) {
    ...
    dBack.style.top = '0';
    dBack.style.left = '0';
    dBack.style.backgroundColor = 'black';
...
function getComment(picName) {
    ...
    req.open('POST', '/Home/AjaxGetComments/12312?name=' + picName, true);
    req.send(null);
}
...
function getVote(picName) {
    ...
    req.open('POST', '/Home/AjaxGetVote/12312?name=' + picName, true);
    req.send(null);
...
function vote(voteSign, picName) {
    ...
    req.open('POST', '/Home/AjaxVote/12312?name=' + picName + '&sign=' + voteSign, true);
